...
public class AddAddressPageObject extends BasePage {
    ...
    public boolean areRequiredFieldsDisplayed() {
        return isElementDisplayed(driver, CommonPageUI.DYNAMIC_TEXTBOX_BY_NAME,"firstname")
                && isElementDisplayed(driver, CommonPageUI.DYNAMIC_TEXTBOX_BY_NAME,"lastname")
                && isElementDisplayed(driver, CommonPageUI.DYNAMIC_TEXTBOX_BY_NAME,"company")
                && isElementDisplayed(driver, CommonPageUI.DYNAMIC_TEXTBOX_BY_NAME,"address_1")
                && isElementDisplayed(driver, CommonPageUI.DYNAMIC_TEXTBOX_BY_NAME,"city")
                && isElementDisplayed(driver, CommonPageUI.DYNAMIC_TEXTBOX_BY_NAME,"postcode");
    }
